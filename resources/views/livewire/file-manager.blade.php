...
>
    ...
    <div class="finder-statusbar">
        ...
        {{-- Theme toggle --}}
        <button
            id="finder-theme-toggle"
            onclick="finderToggleTheme()"
            class="finder-theme-toggle"
            title="{{ __('finder::finder.toggle_theme') }}"
        >
            {{-- Moon: shown in dark mode --}}
            <svg class="finder-icon-moon" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>
            </svg>
            {{-- Sun: shown in light mode --}}
            <svg class="finder-icon-sun" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
